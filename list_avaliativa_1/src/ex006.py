  ...
  match resp:
    ...
    case 3:
      ...
      with open("produtos.txt", "a") as arquivo:
        arquivo.write(f'{last_idx}, {produtos[last_idx]["nome"]}, {produtos[last_idx]["descricao"]}, {produtos[last_idx]["peso"]}, {produtos[last_idx]["valor"]}, {produtos[last_idx]["fornecedor"]}\n')
